...
class STTRequest(BaseModel):
    """Speech-to-text request model (for future extensions)"""

    # Currently handled through file upload, but reserved for query parameters or metadata
    language: Optional[str] = Field(None, description="Language code (e.g., 'en', 'fr') for transcription")
    temperature: Optional[float] = Field(None, description="Sampling temperature for STT", ge=0.0, le=1.0)
